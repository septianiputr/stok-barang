...
<div class="container">
    <div class="p-4 mx-auto col-6 bg-white">
        ...
        <div class="mb-4">
            <h2 class="fw-bold">Ambil Barang Jadi</h2>
        </div>

        <form action="{{ route('barang-jadi-keluar.tambah', $barangJadi->id) }}" method="POST">
            @csrf
            <div class="form-group">
                <label for="kode_barang">Kode Barang</label>
                <input type="text" name="kode_barang" id="kode_barang" class="form-control" value="{{ $barangJadi->id}}" required readonly>
            </div>

            <div class="form-group">
                <label for="">Nama Barang</label>
                <input type="text" name="" id="" class="form-control" value="{{ $barangJadi->nama}}" required readonly>
            </div>
            ...
            <a href="{{route('stok-barang-jadi.show')}}" class="btn btn-secondary mt-2">Kembali</a>
        </form>
    </div>
</div>
